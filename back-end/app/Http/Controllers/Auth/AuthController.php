...
class AuthController extends Controller
{
    ...
    public function loginUser(Request $request)
    {
        ...
        // Retrieve the user using email (retrieveByCredentials)
        $user = Auth::guard('user')->getProvider()->retrieveByCredentials(['email' => $request->email]);

        // Validate credentials (email and password) (validateCredentials)
    ...
    {
        DB::beginTransaction();// The database transaction starts to ensure that all operations either succeed together or fail together.
