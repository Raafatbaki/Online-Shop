...
import { configget, configFile } from "../Library/library.js";
...
export default function EditCategory() {
  ...
  const [errorEditCategory, seterrorEditCategory] = useState("");
  ...
  useEffect(() => {
    ...
    async function getcategories() {
      try {
        ...
        setLoading(false);
        console.log(error);
        seterrorEditCategory(error.message);
      }
    }
